...
public class Item {
    ...
    public Item(String item_code, String item_name, String item_batch, double item_price, double shelf_qty) {
    ...
    public String toString() {
        return "Item{" + "Item code=" + item_code + ", Item name=" + item_name + ", Item batch=" + item_batch + ", Item price=" + item_price + ", Shelf qty=" + shelf_qty + '}';
    }
